...
public class PlatedMod extends AbstractAugmentPlus implements DynvarCarrier {
    ...
    public void onUse(AbstractCard card, AbstractCreature target, UseCardAction action) {
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new PlatedArmorPower(AbstractDungeon.player, baseVal(card)), baseVal(card)));
    }
