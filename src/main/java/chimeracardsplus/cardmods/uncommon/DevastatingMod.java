    ...
    public CardBorderGlowManager.GlowInfo getGlowInfo() {
        return new CardBorderGlowManager.GlowInfo() {
            public boolean test(AbstractCard abstractCard) {
                return DevastatingMod.this.hasThisMod(abstractCard) && Wiz.isInCombat() && AbstractDungeon.getMonsters().monsters.stream().anyMatch((m) -> !m.isDeadOrEscaped() && m.hasPower(WeakPower.POWER_ID));
            }
