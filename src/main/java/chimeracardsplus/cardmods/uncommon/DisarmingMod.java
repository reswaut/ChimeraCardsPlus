...
public class DisarmingMod extends AbstractAugment {
    public static final String ID = ChimeraCardsPlus.makeID(DisarmingMod.class.getSimpleName());
    ...
    public boolean validCard(AbstractCard card) {
        return cardCheck(card, (c) -> ((c.cost == -1 || c.cost >= 1) && doesntUpgradeCost() && doesntUpgradeExhaust() && (c.baseDamage >= 2 || c.baseBlock >= 2 || (c.baseMagicNumber >= 2 && doesntDowngradeMagic())) && usesEnemyTargeting() && !Disarm.ID.equals(c.cardID) && (c.type == AbstractCard.CardType.ATTACK || c.type == AbstractCard.CardType.SKILL)));
    }
