...
public class InfernalMod extends AbstractAugment {
    public static final String ID = ChimeraCardsPlus.makeID(InfernalMod.class.getSimpleName());
    ...
    public boolean validCard(AbstractCard card) {
        return cardCheck(card, (c) -> (c.cost >= -1 && notExhaust(c)
