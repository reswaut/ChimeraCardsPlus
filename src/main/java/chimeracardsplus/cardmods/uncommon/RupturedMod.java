...
public class RupturedMod extends AbstractAugmentPlus {
    public static final String ID = ChimeraCardsPlus.makeID(RupturedMod.class.getSimpleName());
