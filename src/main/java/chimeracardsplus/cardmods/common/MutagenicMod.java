...
public class MutagenicMod extends AbstractAugmentPlus {
    public static final String ID = ChimeraCardsPlus.makeID(MutagenicMod.class.getSimpleName());
