...
public class TemperamentalMod extends AbstractAugment {
    public static final String ID = ChimeraCardsPlus.makeID(TemperamentalMod.class.getSimpleName());
