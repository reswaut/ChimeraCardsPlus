...
public class AnticipativeMod extends AbstractAugmentPlus {
    public static final String ID = ChimeraCardsPlus.makeID(AnticipativeMod.class.getSimpleName());
