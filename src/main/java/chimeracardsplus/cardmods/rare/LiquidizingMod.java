...
public class LiquidizingMod extends AbstractAugmentPlus {
    ...
    public void onUpgradeCheck(AbstractCard card) {
        ...
        Collection<AbstractDamageModifier> toRemove = mods.stream().filter(m -> m instanceof LiquidizingDamage).collect(Collectors.toCollection(() -> new ArrayList<>(1)));
