...
public class LoudMod extends AbstractAugmentPlus {
    ...
    public float modifyBaseMagic(float magic, AbstractCard card) {
        if (Amplify.ID.equals(card.cardID)) {
            return magic + 1.0F;
        }
        return magic;
    }
    ...
    public void onUse(AbstractCard card, AbstractCreature target, UseCardAction action) {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new AmplifyPower(AbstractDungeon.player, 1), 1));
    }
