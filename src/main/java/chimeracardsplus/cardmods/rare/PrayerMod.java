...
public class PrayerMod extends AbstractAugment implements HealingMod {
    public static final String ID = ChimeraCardsPlus.makeID(PrayerMod.class.getSimpleName());
    ...
    public void onUpgradeCheck(AbstractCard card) {
        ...
        Collection<AbstractDamageModifier> toRemove = mods.stream().filter(m -> m instanceof WheelDamage).collect(Collectors.toCollection(() -> new ArrayList<>(1)));
