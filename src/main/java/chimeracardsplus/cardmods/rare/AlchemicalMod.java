...
public class AlchemicalMod extends AbstractAugmentPlus {
    public static final String ID = ChimeraCardsPlus.makeID(AlchemicalMod.class.getSimpleName());
