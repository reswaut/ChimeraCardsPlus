...
public class DecayingMod extends AbstractAugmentPlus {
    public static final String ID = ChimeraCardsPlus.makeID(DecayingMod.class.getSimpleName());
